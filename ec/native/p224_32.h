/* Autogenerated: '../../../fiat-crypto/src/ExtractionOCaml/word_by_word_montgomery' --static --use-value-barrier --inline p224 32 '2^224 - 2^96 + 1' */
...
static FIAT_P224_FIAT_INLINE void fiat_p224_sub(fiat_p224_montgomery_domain_field_element out1, const fiat_p224_montgomery_domain_field_element arg1, const fiat_p224_montgomery_domain_field_element arg2) {
  ...
  fiat_p224_addcarryx_u32(&x16, &x17, 0x0, x1, (fiat_p224_uint1)x15);
...
static FIAT_P224_FIAT_INLINE void fiat_p224_divstep(uint32_t* out1, uint32_t out2[8], uint32_t out3[8], uint32_t out4[7], uint32_t out5[7], uint32_t arg1, const uint32_t arg2[8], const uint32_t arg3[8], const uint32_t arg4[7], const uint32_t arg5[7]) {
  ...
  x3 = (fiat_p224_uint1)((fiat_p224_uint1)(x1 >> 31) & (fiat_p224_uint1)(arg3[0]));
  ...
  fiat_p224_addcarryx_u32(&x98, &x99, 0x0, x83, (fiat_p224_uint1)x97);
  ...
  fiat_p224_cmovznz_u32(&x119, (fiat_p224_uint1)x31, 0x0, x7);
  fiat_p224_cmovznz_u32(&x120, (fiat_p224_uint1)x31, 0x0, x8);
  fiat_p224_cmovznz_u32(&x121, (fiat_p224_uint1)x31, 0x0, x9);
  fiat_p224_cmovznz_u32(&x122, (fiat_p224_uint1)x31, 0x0, x10);
  fiat_p224_cmovznz_u32(&x123, (fiat_p224_uint1)x31, 0x0, x11);
  fiat_p224_cmovznz_u32(&x124, (fiat_p224_uint1)x31, 0x0, x12);
  fiat_p224_cmovznz_u32(&x125, (fiat_p224_uint1)x31, 0x0, x13);
  fiat_p224_cmovznz_u32(&x126, (fiat_p224_uint1)x31, 0x0, x14);
  fiat_p224_addcarryx_u32(&x127, &x128, 0x0, x31, x119);
  fiat_p224_addcarryx_u32(&x129, &x130, x128, x32, x120);
  fiat_p224_addcarryx_u32(&x131, &x132, x130, x33, x121);
  fiat_p224_addcarryx_u32(&x133, &x134, x132, x34, x122);
  fiat_p224_addcarryx_u32(&x135, &x136, x134, x35, x123);
  fiat_p224_addcarryx_u32(&x137, &x138, x136, x36, x124);
  fiat_p224_addcarryx_u32(&x139, &x140, x138, x37, x125);
  fiat_p224_addcarryx_u32(&x141, &x142, x140, x38, x126);
  fiat_p224_cmovznz_u32(&x143, (fiat_p224_uint1)x31, 0x0, x39);
  fiat_p224_cmovznz_u32(&x144, (fiat_p224_uint1)x31, 0x0, x40);
  fiat_p224_cmovznz_u32(&x145, (fiat_p224_uint1)x31, 0x0, x41);
  fiat_p224_cmovznz_u32(&x146, (fiat_p224_uint1)x31, 0x0, x42);
  fiat_p224_cmovznz_u32(&x147, (fiat_p224_uint1)x31, 0x0, x43);
  fiat_p224_cmovznz_u32(&x148, (fiat_p224_uint1)x31, 0x0, x44);
  fiat_p224_cmovznz_u32(&x149, (fiat_p224_uint1)x31, 0x0, x45);
  fiat_p224_addcarryx_u32(&x150, &x151, 0x0, x112, x143);
  fiat_p224_addcarryx_u32(&x152, &x153, x151, x113, x144);
  fiat_p224_addcarryx_u32(&x154, &x155, x153, x114, x145);
  fiat_p224_addcarryx_u32(&x156, &x157, x155, x115, x146);
  fiat_p224_addcarryx_u32(&x158, &x159, x157, x116, x147);
  fiat_p224_addcarryx_u32(&x160, &x161, x159, x117, x148);
  fiat_p224_addcarryx_u32(&x162, &x163, x161, x118, x149);
  fiat_p224_subborrowx_u32(&x164, &x165, 0x0, x150, 0x1);
  fiat_p224_subborrowx_u32(&x166, &x167, x165, x152, 0x0);
  fiat_p224_subborrowx_u32(&x168, &x169, x167, x154, 0x0);
  fiat_p224_subborrowx_u32(&x170, &x171, x169, x156, UINT32_C(0xffffffff));
  fiat_p224_subborrowx_u32(&x172, &x173, x171, x158, UINT32_C(0xffffffff));
  fiat_p224_subborrowx_u32(&x174, &x175, x173, x160, UINT32_C(0xffffffff));
  fiat_p224_subborrowx_u32(&x176, &x177, x175, x162, UINT32_C(0xffffffff));
  fiat_p224_subborrowx_u32(&x178, &x179, x177, x163, 0x0);
  fiat_p224_addcarryx_u32(&x180, &x181, 0x0, x6, 0x1);
  ...
  fiat_p224_cmovznz_u32(&x197, x179, x164, x150);
  fiat_p224_cmovznz_u32(&x198, x179, x166, x152);
  fiat_p224_cmovznz_u32(&x199, x179, x168, x154);
  fiat_p224_cmovznz_u32(&x200, x179, x170, x156);
  fiat_p224_cmovznz_u32(&x201, x179, x172, x158);
  fiat_p224_cmovznz_u32(&x202, x179, x174, x160);
  fiat_p224_cmovznz_u32(&x203, x179, x176, x162);
  *out1 = x180;
  out2[0] = x7;
  out2[1] = x8;
  out2[2] = x9;
