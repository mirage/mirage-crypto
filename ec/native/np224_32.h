/* Autogenerated: '../../../fiat-crypto/src/ExtractionOCaml/word_by_word_montgomery' --static --use-value-barrier --inline np224 32 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFF16A2E0B8F03E13DD29455C5C2A3D mul add opp from_montgomery to_montgomery one msat divstep_precomp divstep to_bytes from_bytes selectznz */
 ...
 *
 */
static FIAT_NP224_FIAT_INLINE void fiat_np224_mul(fiat_np224_montgomery_domain_field_element out1, const fiat_np224_montgomery_domain_field_element arg1, const fiat_np224_montgomery_domain_field_element arg2) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
 ...
 *
 */
static FIAT_NP224_FIAT_INLINE void fiat_np224_add(fiat_np224_montgomery_domain_field_element out1, const fiat_np224_montgomery_domain_field_element arg1, const fiat_np224_montgomery_domain_field_element arg2) {
  uint32_t x1;
  fiat_np224_uint1 x2;
  uint32_t x3;
  fiat_np224_uint1 x4;
 ...
 *
 */
static FIAT_NP224_FIAT_INLINE void fiat_np224_opp(fiat_np224_montgomery_domain_field_element out1, const fiat_np224_montgomery_domain_field_element arg1) {
  uint32_t x1;
  fiat_np224_uint1 x2;
  uint32_t x3;
  fiat_np224_uint1 x4;
 ...
 *
 */
static FIAT_NP224_FIAT_INLINE void fiat_np224_from_montgomery(fiat_np224_non_montgomery_domain_field_element out1, const fiat_np224_montgomery_domain_field_element arg1) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
 ...
 *
 */
static FIAT_NP224_FIAT_INLINE void fiat_np224_to_montgomery(fiat_np224_montgomery_domain_field_element out1, const fiat_np224_non_montgomery_domain_field_element arg1) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
 ...
 *
 */
static FIAT_NP224_FIAT_INLINE void fiat_np224_set_one(fiat_np224_montgomery_domain_field_element out1) {
 ...
 */
static FIAT_NP224_FIAT_INLINE void fiat_np224_msat(uint32_t out1[8]) {
 ...
 */
static FIAT_NP224_FIAT_INLINE void fiat_np224_divstep_precomp(uint32_t out1[7]) {
 ...
 */
static FIAT_NP224_FIAT_INLINE void fiat_np224_divstep(uint32_t* out1, uint32_t out2[8], uint32_t out3[8], uint32_t out4[7], uint32_t out5[7], uint32_t arg1, const uint32_t arg2[8], const uint32_t arg3[8], const uint32_t arg4[7], const uint32_t arg5[7]) {
  uint32_t x1;
  fiat_np224_uint1 x2;
  fiat_np224_uint1 x3;
  uint32_t x4;
  ...
  x3 = (fiat_np224_uint1)((fiat_np224_uint1)(x1 >> 31) & (fiat_np224_uint1)(arg3[0]));
  ...
  fiat_np224_cmovznz_u32(&x119, (fiat_np224_uint1)x31, 0x0, x7);
  fiat_np224_cmovznz_u32(&x120, (fiat_np224_uint1)x31, 0x0, x8);
  fiat_np224_cmovznz_u32(&x121, (fiat_np224_uint1)x31, 0x0, x9);
  fiat_np224_cmovznz_u32(&x122, (fiat_np224_uint1)x31, 0x0, x10);
  fiat_np224_cmovznz_u32(&x123, (fiat_np224_uint1)x31, 0x0, x11);
  fiat_np224_cmovznz_u32(&x124, (fiat_np224_uint1)x31, 0x0, x12);
  fiat_np224_cmovznz_u32(&x125, (fiat_np224_uint1)x31, 0x0, x13);
  fiat_np224_cmovznz_u32(&x126, (fiat_np224_uint1)x31, 0x0, x14);
  fiat_np224_addcarryx_u32(&x127, &x128, 0x0, x31, x119);
  fiat_np224_addcarryx_u32(&x129, &x130, x128, x32, x120);
  fiat_np224_addcarryx_u32(&x131, &x132, x130, x33, x121);
  fiat_np224_addcarryx_u32(&x133, &x134, x132, x34, x122);
  fiat_np224_addcarryx_u32(&x135, &x136, x134, x35, x123);
  fiat_np224_addcarryx_u32(&x137, &x138, x136, x36, x124);
  fiat_np224_addcarryx_u32(&x139, &x140, x138, x37, x125);
  fiat_np224_addcarryx_u32(&x141, &x142, x140, x38, x126);
  fiat_np224_cmovznz_u32(&x143, (fiat_np224_uint1)x31, 0x0, x39);
  fiat_np224_cmovznz_u32(&x144, (fiat_np224_uint1)x31, 0x0, x40);
  fiat_np224_cmovznz_u32(&x145, (fiat_np224_uint1)x31, 0x0, x41);
  fiat_np224_cmovznz_u32(&x146, (fiat_np224_uint1)x31, 0x0, x42);
  fiat_np224_cmovznz_u32(&x147, (fiat_np224_uint1)x31, 0x0, x43);
  fiat_np224_cmovznz_u32(&x148, (fiat_np224_uint1)x31, 0x0, x44);
  fiat_np224_cmovznz_u32(&x149, (fiat_np224_uint1)x31, 0x0, x45);
  fiat_np224_addcarryx_u32(&x150, &x151, 0x0, x112, x143);
  fiat_np224_addcarryx_u32(&x152, &x153, x151, x113, x144);
  fiat_np224_addcarryx_u32(&x154, &x155, x153, x114, x145);
  fiat_np224_addcarryx_u32(&x156, &x157, x155, x115, x146);
  fiat_np224_addcarryx_u32(&x158, &x159, x157, x116, x147);
  fiat_np224_addcarryx_u32(&x160, &x161, x159, x117, x148);
  fiat_np224_addcarryx_u32(&x162, &x163, x161, x118, x149);
  fiat_np224_subborrowx_u32(&x164, &x165, 0x0, x150, UINT32_C(0x5c5c2a3d));
  fiat_np224_subborrowx_u32(&x166, &x167, x165, x152, UINT32_C(0x13dd2945));
  fiat_np224_subborrowx_u32(&x168, &x169, x167, x154, UINT32_C(0xe0b8f03e));
  fiat_np224_subborrowx_u32(&x170, &x171, x169, x156, UINT32_C(0xffff16a2));
  fiat_np224_subborrowx_u32(&x172, &x173, x171, x158, UINT32_C(0xffffffff));
  fiat_np224_subborrowx_u32(&x174, &x175, x173, x160, UINT32_C(0xffffffff));
  fiat_np224_subborrowx_u32(&x176, &x177, x175, x162, UINT32_C(0xffffffff));
  fiat_np224_subborrowx_u32(&x178, &x179, x177, x163, 0x0);
  fiat_np224_addcarryx_u32(&x180, &x181, 0x0, x6, 0x1);
  x182 = ((x127 >> 1) | ((x129 << 31) & UINT32_C(0xffffffff)));
  x183 = ((x129 >> 1) | ((x131 << 31) & UINT32_C(0xffffffff)));
  x184 = ((x131 >> 1) | ((x133 << 31) & UINT32_C(0xffffffff)));
  x185 = ((x133 >> 1) | ((x135 << 31) & UINT32_C(0xffffffff)));
  x186 = ((x135 >> 1) | ((x137 << 31) & UINT32_C(0xffffffff)));
  x187 = ((x137 >> 1) | ((x139 << 31) & UINT32_C(0xffffffff)));
  x188 = ((x139 >> 1) | ((x141 << 31) & UINT32_C(0xffffffff)));
  x189 = ((x141 & UINT32_C(0x80000000)) | (x141 >> 1));
  fiat_np224_cmovznz_u32(&x190, x75, x60, x46);
  fiat_np224_cmovznz_u32(&x191, x75, x62, x48);
  fiat_np224_cmovznz_u32(&x192, x75, x64, x50);
  fiat_np224_cmovznz_u32(&x193, x75, x66, x52);
  fiat_np224_cmovznz_u32(&x194, x75, x68, x54);
  fiat_np224_cmovznz_u32(&x195, x75, x70, x56);
  fiat_np224_cmovznz_u32(&x196, x75, x72, x58);
  fiat_np224_cmovznz_u32(&x197, x179, x164, x150);
  fiat_np224_cmovznz_u32(&x198, x179, x166, x152);
  fiat_np224_cmovznz_u32(&x199, x179, x168, x154);
  fiat_np224_cmovznz_u32(&x200, x179, x170, x156);
  fiat_np224_cmovznz_u32(&x201, x179, x172, x158);
  fiat_np224_cmovznz_u32(&x202, x179, x174, x160);
  fiat_np224_cmovznz_u32(&x203, x179, x176, x162);
  *out1 = x180;
  out2[0] = x7;
  out2[1] = x8;
  out2[2] = x9;
 ...
 */
static FIAT_NP224_FIAT_INLINE void fiat_np224_to_bytes(uint8_t out1[28], const uint32_t arg1[7]) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
 ...
 *   out1: [[0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff]]
 */
static FIAT_NP224_FIAT_INLINE void fiat_np224_from_bytes(uint32_t out1[7], const uint8_t arg1[28]) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint8_t x4;
 ...
 *   out1: [[0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff]]
 */
static FIAT_NP224_FIAT_INLINE void fiat_np224_selectznz(uint32_t out1[7], fiat_np224_uint1 arg1, const uint32_t arg2[7], const uint32_t arg3[7]) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
