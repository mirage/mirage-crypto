/* Autogenerated: '../../../fiat-crypto/src/ExtractionOCaml/word_by_word_montgomery' --static --use-value-barrier --inline p384 32 '2^384 - 2^128 - 2^96 + 2^32 - 1' */
 ...
 *
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_mul(fiat_p384_montgomery_domain_field_element out1, const fiat_p384_montgomery_domain_field_element arg1, const fiat_p384_montgomery_domain_field_element arg2) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
 ...
 *
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_square(fiat_p384_montgomery_domain_field_element out1, const fiat_p384_montgomery_domain_field_element arg1) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
 ...
 *
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_add(fiat_p384_montgomery_domain_field_element out1, const fiat_p384_montgomery_domain_field_element arg1, const fiat_p384_montgomery_domain_field_element arg2) {
  uint32_t x1;
  fiat_p384_uint1 x2;
  uint32_t x3;
  fiat_p384_uint1 x4;
 ...
 *
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_sub(fiat_p384_montgomery_domain_field_element out1, const fiat_p384_montgomery_domain_field_element arg1, const fiat_p384_montgomery_domain_field_element arg2) {
  uint32_t x1;
  fiat_p384_uint1 x2;
  uint32_t x3;
  fiat_p384_uint1 x4;
 ...
 *
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_opp(fiat_p384_montgomery_domain_field_element out1, const fiat_p384_montgomery_domain_field_element arg1) {
  uint32_t x1;
  fiat_p384_uint1 x2;
  uint32_t x3;
  fiat_p384_uint1 x4;
 ...
 *
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_from_montgomery(fiat_p384_non_montgomery_domain_field_element out1, const fiat_p384_montgomery_domain_field_element arg1) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
 ...
 *
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_to_montgomery(fiat_p384_montgomery_domain_field_element out1, const fiat_p384_non_montgomery_domain_field_element arg1) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
 ...
 *   out1: [0x0 ~> 0xffffffff]
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_nonzero(uint32_t* out1, const uint32_t arg1[12]) {
  uint32_t x1;
 ...
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_selectznz(uint32_t out1[12], fiat_p384_uint1 arg1, const uint32_t arg2[12], const uint32_t arg3[12]) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
 ...
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_to_bytes(uint8_t out1[48], const uint32_t arg1[12]) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
 ...
 *   out1: [[0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff]]
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_from_bytes(uint32_t out1[12], const uint8_t arg1[48]) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint8_t x4;
 ...
 *
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_set_one(fiat_p384_montgomery_domain_field_element out1) {
  out1[0] = 0x1;
 ...
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_msat(uint32_t out1[13]) {
 ...
 *   out1: [[0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff]]
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_divstep_precomp(uint32_t out1[12]) {
 ...
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_divstep(uint32_t* out1, uint32_t out2[13], uint32_t out3[13], uint32_t out4[12], uint32_t out5[12], uint32_t arg1, const uint32_t arg2[13], const uint32_t arg3[13], const uint32_t arg4[12], const uint32_t arg5[12]) {
  uint32_t x1;
  fiat_p384_uint1 x2;
  fiat_p384_uint1 x3;
  uint32_t x4;
  ...
  x3 = (fiat_p384_uint1)((fiat_p384_uint1)(x1 >> 31) & (fiat_p384_uint1)(arg3[0]));
  ...
  fiat_p384_cmovznz_u32(&x194, (fiat_p384_uint1)x46, 0x0, x7);
  fiat_p384_cmovznz_u32(&x195, (fiat_p384_uint1)x46, 0x0, x8);
  fiat_p384_cmovznz_u32(&x196, (fiat_p384_uint1)x46, 0x0, x9);
  fiat_p384_cmovznz_u32(&x197, (fiat_p384_uint1)x46, 0x0, x10);
  fiat_p384_cmovznz_u32(&x198, (fiat_p384_uint1)x46, 0x0, x11);
  fiat_p384_cmovznz_u32(&x199, (fiat_p384_uint1)x46, 0x0, x12);
  fiat_p384_cmovznz_u32(&x200, (fiat_p384_uint1)x46, 0x0, x13);
  fiat_p384_cmovznz_u32(&x201, (fiat_p384_uint1)x46, 0x0, x14);
  fiat_p384_cmovznz_u32(&x202, (fiat_p384_uint1)x46, 0x0, x15);
  fiat_p384_cmovznz_u32(&x203, (fiat_p384_uint1)x46, 0x0, x16);
  fiat_p384_cmovznz_u32(&x204, (fiat_p384_uint1)x46, 0x0, x17);
  fiat_p384_cmovznz_u32(&x205, (fiat_p384_uint1)x46, 0x0, x18);
  fiat_p384_cmovznz_u32(&x206, (fiat_p384_uint1)x46, 0x0, x19);
  fiat_p384_addcarryx_u32(&x207, &x208, 0x0, x46, x194);
  fiat_p384_addcarryx_u32(&x209, &x210, x208, x47, x195);
  fiat_p384_addcarryx_u32(&x211, &x212, x210, x48, x196);
  fiat_p384_addcarryx_u32(&x213, &x214, x212, x49, x197);
  fiat_p384_addcarryx_u32(&x215, &x216, x214, x50, x198);
  fiat_p384_addcarryx_u32(&x217, &x218, x216, x51, x199);
  fiat_p384_addcarryx_u32(&x219, &x220, x218, x52, x200);
  fiat_p384_addcarryx_u32(&x221, &x222, x220, x53, x201);
  fiat_p384_addcarryx_u32(&x223, &x224, x222, x54, x202);
  fiat_p384_addcarryx_u32(&x225, &x226, x224, x55, x203);
  fiat_p384_addcarryx_u32(&x227, &x228, x226, x56, x204);
  fiat_p384_addcarryx_u32(&x229, &x230, x228, x57, x205);
  fiat_p384_addcarryx_u32(&x231, &x232, x230, x58, x206);
  fiat_p384_cmovznz_u32(&x233, (fiat_p384_uint1)x46, 0x0, x59);
  fiat_p384_cmovznz_u32(&x234, (fiat_p384_uint1)x46, 0x0, x60);
  fiat_p384_cmovznz_u32(&x235, (fiat_p384_uint1)x46, 0x0, x61);
  fiat_p384_cmovznz_u32(&x236, (fiat_p384_uint1)x46, 0x0, x62);
  fiat_p384_cmovznz_u32(&x237, (fiat_p384_uint1)x46, 0x0, x63);
  fiat_p384_cmovznz_u32(&x238, (fiat_p384_uint1)x46, 0x0, x64);
  fiat_p384_cmovznz_u32(&x239, (fiat_p384_uint1)x46, 0x0, x65);
  fiat_p384_cmovznz_u32(&x240, (fiat_p384_uint1)x46, 0x0, x66);
  fiat_p384_cmovznz_u32(&x241, (fiat_p384_uint1)x46, 0x0, x67);
  fiat_p384_cmovznz_u32(&x242, (fiat_p384_uint1)x46, 0x0, x68);
  fiat_p384_cmovznz_u32(&x243, (fiat_p384_uint1)x46, 0x0, x69);
  fiat_p384_cmovznz_u32(&x244, (fiat_p384_uint1)x46, 0x0, x70);
  fiat_p384_addcarryx_u32(&x245, &x246, 0x0, x182, x233);
  fiat_p384_addcarryx_u32(&x247, &x248, x246, x183, x234);
  fiat_p384_addcarryx_u32(&x249, &x250, x248, x184, x235);
  fiat_p384_addcarryx_u32(&x251, &x252, x250, x185, x236);
  fiat_p384_addcarryx_u32(&x253, &x254, x252, x186, x237);
  fiat_p384_addcarryx_u32(&x255, &x256, x254, x187, x238);
  fiat_p384_addcarryx_u32(&x257, &x258, x256, x188, x239);
  fiat_p384_addcarryx_u32(&x259, &x260, x258, x189, x240);
  fiat_p384_addcarryx_u32(&x261, &x262, x260, x190, x241);
  fiat_p384_addcarryx_u32(&x263, &x264, x262, x191, x242);
  fiat_p384_addcarryx_u32(&x265, &x266, x264, x192, x243);
  fiat_p384_addcarryx_u32(&x267, &x268, x266, x193, x244);
  fiat_p384_subborrowx_u32(&x269, &x270, 0x0, x245, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u32(&x271, &x272, x270, x247, 0x0);
  fiat_p384_subborrowx_u32(&x273, &x274, x272, x249, 0x0);
  fiat_p384_subborrowx_u32(&x275, &x276, x274, x251, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u32(&x277, &x278, x276, x253, UINT32_C(0xfffffffe));
  fiat_p384_subborrowx_u32(&x279, &x280, x278, x255, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u32(&x281, &x282, x280, x257, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u32(&x283, &x284, x282, x259, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u32(&x285, &x286, x284, x261, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u32(&x287, &x288, x286, x263, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u32(&x289, &x290, x288, x265, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u32(&x291, &x292, x290, x267, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u32(&x293, &x294, x292, x268, 0x0);
  fiat_p384_addcarryx_u32(&x295, &x296, 0x0, x6, 0x1);
  x297 = ((x207 >> 1) | ((x209 << 31) & UINT32_C(0xffffffff)));
  x298 = ((x209 >> 1) | ((x211 << 31) & UINT32_C(0xffffffff)));
  x299 = ((x211 >> 1) | ((x213 << 31) & UINT32_C(0xffffffff)));
  x300 = ((x213 >> 1) | ((x215 << 31) & UINT32_C(0xffffffff)));
  x301 = ((x215 >> 1) | ((x217 << 31) & UINT32_C(0xffffffff)));
  x302 = ((x217 >> 1) | ((x219 << 31) & UINT32_C(0xffffffff)));
  x303 = ((x219 >> 1) | ((x221 << 31) & UINT32_C(0xffffffff)));
  x304 = ((x221 >> 1) | ((x223 << 31) & UINT32_C(0xffffffff)));
  x305 = ((x223 >> 1) | ((x225 << 31) & UINT32_C(0xffffffff)));
  x306 = ((x225 >> 1) | ((x227 << 31) & UINT32_C(0xffffffff)));
  x307 = ((x227 >> 1) | ((x229 << 31) & UINT32_C(0xffffffff)));
  x308 = ((x229 >> 1) | ((x231 << 31) & UINT32_C(0xffffffff)));
  x309 = ((x231 & UINT32_C(0x80000000)) | (x231 >> 1));
  fiat_p384_cmovznz_u32(&x310, x120, x95, x71);
  fiat_p384_cmovznz_u32(&x311, x120, x97, x73);
  fiat_p384_cmovznz_u32(&x312, x120, x99, x75);
  fiat_p384_cmovznz_u32(&x313, x120, x101, x77);
  fiat_p384_cmovznz_u32(&x314, x120, x103, x79);
  fiat_p384_cmovznz_u32(&x315, x120, x105, x81);
  fiat_p384_cmovznz_u32(&x316, x120, x107, x83);
  fiat_p384_cmovznz_u32(&x317, x120, x109, x85);
  fiat_p384_cmovznz_u32(&x318, x120, x111, x87);
  fiat_p384_cmovznz_u32(&x319, x120, x113, x89);
  fiat_p384_cmovznz_u32(&x320, x120, x115, x91);
  fiat_p384_cmovznz_u32(&x321, x120, x117, x93);
  fiat_p384_cmovznz_u32(&x322, x294, x269, x245);
  fiat_p384_cmovznz_u32(&x323, x294, x271, x247);
  fiat_p384_cmovznz_u32(&x324, x294, x273, x249);
  fiat_p384_cmovznz_u32(&x325, x294, x275, x251);
  fiat_p384_cmovznz_u32(&x326, x294, x277, x253);
  fiat_p384_cmovznz_u32(&x327, x294, x279, x255);
  fiat_p384_cmovznz_u32(&x328, x294, x281, x257);
  fiat_p384_cmovznz_u32(&x329, x294, x283, x259);
  fiat_p384_cmovznz_u32(&x330, x294, x285, x261);
  fiat_p384_cmovznz_u32(&x331, x294, x287, x263);
  fiat_p384_cmovznz_u32(&x332, x294, x289, x265);
  fiat_p384_cmovznz_u32(&x333, x294, x291, x267);
  *out1 = x295;
  out2[0] = x7;
  out2[1] = x8;
  out2[2] = x9;
