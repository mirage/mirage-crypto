/* Autogenerated: '../../../fiat-crypto/src/ExtractionOCaml/word_by_word_montgomery' --static --use-value-barrier --inline p384 64 '2^384 - 2^128 - 2^96 + 2^32 - 1' */
 ...
 *   out1: [0x0 ~> 0xffffffffffffffff]
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_nonzero(uint64_t* out1, const uint64_t arg1[6]) {
  uint64_t x1;
 ...
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_selectznz(uint64_t out1[6], fiat_p384_uint1 arg1, const uint64_t arg2[6], const uint64_t arg3[6]) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
  uint64_t x4;
 ...
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_to_bytes(uint8_t out1[48], const uint64_t arg1[6]) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
  uint64_t x4;
 ...
 *   out1: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_from_bytes(uint64_t out1[6], const uint8_t arg1[48]) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
  uint64_t x4;
 ...
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_msat(uint64_t out1[7]) {
 ...
 *   out1: [[0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff], [0x0 ~> 0xffffffffffffffff]]
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_divstep_precomp(uint64_t out1[6]) {
 ...
 */
static FIAT_P384_FIAT_INLINE void fiat_p384_divstep(uint64_t* out1, uint64_t out2[7], uint64_t out3[7], uint64_t out4[6], uint64_t out5[6], uint64_t arg1, const uint64_t arg2[7], const uint64_t arg3[7], const uint64_t arg4[6], const uint64_t arg5[6]) {
  uint64_t x1;
  fiat_p384_uint1 x2;
  fiat_p384_uint1 x3;
  uint64_t x4;
  ...
  x3 = (fiat_p384_uint1)((fiat_p384_uint1)(x1 >> 63) & (fiat_p384_uint1)(arg3[0]));
  ...
  fiat_p384_cmovznz_u64(&x104, (fiat_p384_uint1)x28, 0x0, x7);
  fiat_p384_cmovznz_u64(&x105, (fiat_p384_uint1)x28, 0x0, x8);
  fiat_p384_cmovznz_u64(&x106, (fiat_p384_uint1)x28, 0x0, x9);
  fiat_p384_cmovznz_u64(&x107, (fiat_p384_uint1)x28, 0x0, x10);
  fiat_p384_cmovznz_u64(&x108, (fiat_p384_uint1)x28, 0x0, x11);
  fiat_p384_cmovznz_u64(&x109, (fiat_p384_uint1)x28, 0x0, x12);
  fiat_p384_cmovznz_u64(&x110, (fiat_p384_uint1)x28, 0x0, x13);
  fiat_p384_addcarryx_u64(&x111, &x112, 0x0, x28, x104);
  fiat_p384_addcarryx_u64(&x113, &x114, x112, x29, x105);
  fiat_p384_addcarryx_u64(&x115, &x116, x114, x30, x106);
  fiat_p384_addcarryx_u64(&x117, &x118, x116, x31, x107);
  fiat_p384_addcarryx_u64(&x119, &x120, x118, x32, x108);
  fiat_p384_addcarryx_u64(&x121, &x122, x120, x33, x109);
  fiat_p384_addcarryx_u64(&x123, &x124, x122, x34, x110);
  fiat_p384_cmovznz_u64(&x125, (fiat_p384_uint1)x28, 0x0, x35);
  fiat_p384_cmovznz_u64(&x126, (fiat_p384_uint1)x28, 0x0, x36);
  fiat_p384_cmovznz_u64(&x127, (fiat_p384_uint1)x28, 0x0, x37);
  fiat_p384_cmovznz_u64(&x128, (fiat_p384_uint1)x28, 0x0, x38);
  fiat_p384_cmovznz_u64(&x129, (fiat_p384_uint1)x28, 0x0, x39);
  fiat_p384_cmovznz_u64(&x130, (fiat_p384_uint1)x28, 0x0, x40);
  fiat_p384_addcarryx_u64(&x131, &x132, 0x0, x98, x125);
  fiat_p384_addcarryx_u64(&x133, &x134, x132, x99, x126);
  fiat_p384_addcarryx_u64(&x135, &x136, x134, x100, x127);
  fiat_p384_addcarryx_u64(&x137, &x138, x136, x101, x128);
  fiat_p384_addcarryx_u64(&x139, &x140, x138, x102, x129);
  fiat_p384_addcarryx_u64(&x141, &x142, x140, x103, x130);
  fiat_p384_subborrowx_u64(&x143, &x144, 0x0, x131, UINT32_C(0xffffffff));
  fiat_p384_subborrowx_u64(&x145, &x146, x144, x133, UINT64_C(0xffffffff00000000));
  fiat_p384_subborrowx_u64(&x147, &x148, x146, x135, UINT64_C(0xfffffffffffffffe));
  fiat_p384_subborrowx_u64(&x149, &x150, x148, x137, UINT64_C(0xffffffffffffffff));
  fiat_p384_subborrowx_u64(&x151, &x152, x150, x139, UINT64_C(0xffffffffffffffff));
  fiat_p384_subborrowx_u64(&x153, &x154, x152, x141, UINT64_C(0xffffffffffffffff));
  fiat_p384_subborrowx_u64(&x155, &x156, x154, x142, 0x0);
  fiat_p384_addcarryx_u64(&x157, &x158, 0x0, x6, 0x1);
  ...
  fiat_p384_cmovznz_u64(&x172, x156, x143, x131);
  fiat_p384_cmovznz_u64(&x173, x156, x145, x133);
  fiat_p384_cmovznz_u64(&x174, x156, x147, x135);
  fiat_p384_cmovznz_u64(&x175, x156, x149, x137);
  fiat_p384_cmovznz_u64(&x176, x156, x151, x139);
  fiat_p384_cmovznz_u64(&x177, x156, x153, x141);
  *out1 = x157;
  out2[0] = x7;
  out2[1] = x8;
  out2[2] = x9;
