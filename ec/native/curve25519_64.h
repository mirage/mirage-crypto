/* Autogenerated: '../../../fiat-crypto/src/ExtractionOCaml/unsaturated_solinas' --static --use-value-barrier --inline 25519 64 '(auto)' '2^255 - 19' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes carry_scmul121666 */
...
static FIAT_25519_FIAT_INLINE void fiat_25519_to_bytes(uint8_t out1[32], const fiat_25519_tight_field_element arg1) {
  ...
  x44 = (x43 >> 8);
  x45 = (x44 >> 8);
  x46 = (fiat_25519_uint1)(x45 >> 8);
  x47 = (x23 + (uint64_t)x46);
  x48 = (x47 >> 8);
  x49 = (x48 >> 8);
  x50 = (x49 >> 8);
  x51 = (x50 >> 8);
