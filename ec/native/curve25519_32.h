/* Autogenerated: '../../../fiat-crypto/src/ExtractionOCaml/unsaturated_solinas' --static --use-value-barrier --inline 25519 32 '(auto)' '2^255 - 19' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes carry_scmul121666 */
...
static FIAT_25519_FIAT_INLINE void fiat_25519_to_bytes(uint8_t out1[32], const fiat_25519_tight_field_element arg1) {
  ...
  x51 = (x50 >> 8);
  x52 = (uint8_t)(x51 >> 8);
  x53 = (x49 + (uint32_t)x52);
  x54 = (x53 >> 8);
  x55 = (x54 >> 8);
  x56 = (uint8_t)(x55 >> 8);
  x57 = (x48 + (uint32_t)x56);
  x58 = (x57 >> 8);
  x59 = (x58 >> 8);
  x60 = (uint8_t)(x59 >> 8);
  x61 = (x47 + (uint32_t)x60);
  x62 = (x61 >> 8);
  x63 = (x62 >> 8);
  x64 = (uint8_t)(x63 >> 8);
  x65 = (x46 + (uint32_t)x64);
  x66 = (x65 >> 8);
  x67 = (x66 >> 8);
  x68 = (uint8_t)(x67 >> 8);
  x69 = (x32 >> 8);
  x70 = (x69 >> 8);
  x71 = (fiat_25519_uint1)(x70 >> 8);
  x72 = (x45 + (uint32_t)x71);
  x73 = (x72 >> 8);
  x74 = (x73 >> 8);
  x75 = (uint8_t)(x74 >> 8);
  x76 = (x44 + (uint32_t)x75);
  x77 = (x76 >> 8);
  x78 = (x77 >> 8);
  x79 = (uint8_t)(x78 >> 8);
  x80 = (x43 + (uint32_t)x79);
  x81 = (x80 >> 8);
  x82 = (x81 >> 8);
  x83 = (uint8_t)(x82 >> 8);
  x84 = (x42 + (uint32_t)x83);
  x85 = (x84 >> 8);
  x86 = (x85 >> 8);
  x87 = (uint8_t)(x86 >> 8);
  out1[0] = (uint8_t)x22;
