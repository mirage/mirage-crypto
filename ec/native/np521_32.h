 ...
 *
 */
static FIAT_NP521_FIAT_INLINE void fiat_np521_mul(fiat_np521_montgomery_domain_field_element out1, const fiat_np521_montgomery_domain_field_element arg1, const fiat_np521_montgomery_domain_field_element arg2) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
 ...
 *
 */
static FIAT_NP521_FIAT_INLINE void fiat_np521_add(fiat_np521_montgomery_domain_field_element out1, const fiat_np521_montgomery_domain_field_element arg1, const fiat_np521_montgomery_domain_field_element arg2) {
  uint32_t x1;
  fiat_np521_uint1 x2;
  uint32_t x3;
  fiat_np521_uint1 x4;
 ...
 *
 */
static FIAT_NP521_FIAT_INLINE void fiat_np521_opp(fiat_np521_montgomery_domain_field_element out1, const fiat_np521_montgomery_domain_field_element arg1) {
  uint32_t x1;
  fiat_np521_uint1 x2;
  uint32_t x3;
  fiat_np521_uint1 x4;
 ...
 *
 */
static FIAT_NP521_FIAT_INLINE void fiat_np521_from_montgomery(fiat_np521_non_montgomery_domain_field_element out1, const fiat_np521_montgomery_domain_field_element arg1) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
 ...
 *
 */
static FIAT_NP521_FIAT_INLINE void fiat_np521_to_montgomery(fiat_np521_montgomery_domain_field_element out1, const fiat_np521_non_montgomery_domain_field_element arg1) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
 ...
 *
 */
static FIAT_NP521_FIAT_INLINE void fiat_np521_set_one(fiat_np521_montgomery_domain_field_element out1) {
 ...
 */
static FIAT_NP521_FIAT_INLINE void fiat_np521_msat(uint32_t out1[18]) {
 ...
 */
static FIAT_NP521_FIAT_INLINE void fiat_np521_divstep_precomp(uint32_t out1[17]) {
 ...
 */
static FIAT_NP521_FIAT_INLINE void fiat_np521_divstep(uint32_t* out1, uint32_t out2[18], uint32_t out3[18], uint32_t out4[17], uint32_t out5[17], uint32_t arg1, const uint32_t arg2[18], const uint32_t arg3[18], const uint32_t arg4[17], const uint32_t arg5[17]) {
  uint32_t x1;
  fiat_np521_uint1 x2;
  fiat_np521_uint1 x3;
  uint32_t x4;
  ...
  fiat_np521_uint1 x292;
  uint32_t x293;
  fiat_np521_uint1 x294;
  uint32_t x295;
  fiat_np521_uint1 x296;
  uint32_t x297;
  fiat_np521_uint1 x298;
  uint32_t x299;
  fiat_np521_uint1 x300;
  uint32_t x301;
  fiat_np521_uint1 x302;
  uint32_t x303;
  fiat_np521_uint1 x304;
  uint32_t x305;
  fiat_np521_uint1 x306;
  uint32_t x307;
  ...
  x3 = (fiat_np521_uint1)((fiat_np521_uint1)(x1 >> 31) & (fiat_np521_uint1)(arg3[0]));
  ...
  fiat_np521_cmovznz_u32(&x269, (fiat_np521_uint1)x61, 0x0, x7);
  fiat_np521_cmovznz_u32(&x270, (fiat_np521_uint1)x61, 0x0, x8);
  fiat_np521_cmovznz_u32(&x271, (fiat_np521_uint1)x61, 0x0, x9);
  fiat_np521_cmovznz_u32(&x272, (fiat_np521_uint1)x61, 0x0, x10);
  fiat_np521_cmovznz_u32(&x273, (fiat_np521_uint1)x61, 0x0, x11);
  fiat_np521_cmovznz_u32(&x274, (fiat_np521_uint1)x61, 0x0, x12);
  fiat_np521_cmovznz_u32(&x275, (fiat_np521_uint1)x61, 0x0, x13);
  fiat_np521_cmovznz_u32(&x276, (fiat_np521_uint1)x61, 0x0, x14);
  fiat_np521_cmovznz_u32(&x277, (fiat_np521_uint1)x61, 0x0, x15);
  fiat_np521_cmovznz_u32(&x278, (fiat_np521_uint1)x61, 0x0, x16);
  fiat_np521_cmovznz_u32(&x279, (fiat_np521_uint1)x61, 0x0, x17);
  fiat_np521_cmovznz_u32(&x280, (fiat_np521_uint1)x61, 0x0, x18);
  fiat_np521_cmovznz_u32(&x281, (fiat_np521_uint1)x61, 0x0, x19);
  fiat_np521_cmovznz_u32(&x282, (fiat_np521_uint1)x61, 0x0, x20);
  fiat_np521_cmovznz_u32(&x283, (fiat_np521_uint1)x61, 0x0, x21);
  fiat_np521_cmovznz_u32(&x284, (fiat_np521_uint1)x61, 0x0, x22);
  fiat_np521_cmovznz_u32(&x285, (fiat_np521_uint1)x61, 0x0, x23);
  fiat_np521_cmovznz_u32(&x286, (fiat_np521_uint1)x61, 0x0, x24);
  fiat_np521_addcarryx_u32(&x287, &x288, 0x0, x61, x269);
  fiat_np521_addcarryx_u32(&x289, &x290, x288, x62, x270);
  fiat_np521_addcarryx_u32(&x291, &x292, x290, x63, x271);
  fiat_np521_addcarryx_u32(&x293, &x294, x292, x64, x272);
  fiat_np521_addcarryx_u32(&x295, &x296, x294, x65, x273);
  fiat_np521_addcarryx_u32(&x297, &x298, x296, x66, x274);
  fiat_np521_addcarryx_u32(&x299, &x300, x298, x67, x275);
  fiat_np521_addcarryx_u32(&x301, &x302, x300, x68, x276);
  fiat_np521_addcarryx_u32(&x303, &x304, x302, x69, x277);
  fiat_np521_addcarryx_u32(&x305, &x306, x304, x70, x278);
  fiat_np521_addcarryx_u32(&x307, &x308, x306, x71, x279);
  fiat_np521_addcarryx_u32(&x309, &x310, x308, x72, x280);
  fiat_np521_addcarryx_u32(&x311, &x312, x310, x73, x281);
  fiat_np521_addcarryx_u32(&x313, &x314, x312, x74, x282);
  fiat_np521_addcarryx_u32(&x315, &x316, x314, x75, x283);
  fiat_np521_addcarryx_u32(&x317, &x318, x316, x76, x284);
  fiat_np521_addcarryx_u32(&x319, &x320, x318, x77, x285);
  fiat_np521_addcarryx_u32(&x321, &x322, x320, x78, x286);
  fiat_np521_cmovznz_u32(&x323, (fiat_np521_uint1)x61, 0x0, x79);
  fiat_np521_cmovznz_u32(&x324, (fiat_np521_uint1)x61, 0x0, x80);
  fiat_np521_cmovznz_u32(&x325, (fiat_np521_uint1)x61, 0x0, x81);
  fiat_np521_cmovznz_u32(&x326, (fiat_np521_uint1)x61, 0x0, x82);
  fiat_np521_cmovznz_u32(&x327, (fiat_np521_uint1)x61, 0x0, x83);
  fiat_np521_cmovznz_u32(&x328, (fiat_np521_uint1)x61, 0x0, x84);
  fiat_np521_cmovznz_u32(&x329, (fiat_np521_uint1)x61, 0x0, x85);
  fiat_np521_cmovznz_u32(&x330, (fiat_np521_uint1)x61, 0x0, x86);
  fiat_np521_cmovznz_u32(&x331, (fiat_np521_uint1)x61, 0x0, x87);
  fiat_np521_cmovznz_u32(&x332, (fiat_np521_uint1)x61, 0x0, x88);
  fiat_np521_cmovznz_u32(&x333, (fiat_np521_uint1)x61, 0x0, x89);
  fiat_np521_cmovznz_u32(&x334, (fiat_np521_uint1)x61, 0x0, x90);
  fiat_np521_cmovznz_u32(&x335, (fiat_np521_uint1)x61, 0x0, x91);
  fiat_np521_cmovznz_u32(&x336, (fiat_np521_uint1)x61, 0x0, x92);
  fiat_np521_cmovznz_u32(&x337, (fiat_np521_uint1)x61, 0x0, x93);
  fiat_np521_cmovznz_u32(&x338, (fiat_np521_uint1)x61, 0x0, x94);
  fiat_np521_cmovznz_u32(&x339, (fiat_np521_uint1)x61, 0x0, x95);
  fiat_np521_addcarryx_u32(&x340, &x341, 0x0, x252, x323);
  fiat_np521_addcarryx_u32(&x342, &x343, x341, x253, x324);
  fiat_np521_addcarryx_u32(&x344, &x345, x343, x254, x325);
  fiat_np521_addcarryx_u32(&x346, &x347, x345, x255, x326);
  fiat_np521_addcarryx_u32(&x348, &x349, x347, x256, x327);
  fiat_np521_addcarryx_u32(&x350, &x351, x349, x257, x328);
  fiat_np521_addcarryx_u32(&x352, &x353, x351, x258, x329);
  fiat_np521_addcarryx_u32(&x354, &x355, x353, x259, x330);
  fiat_np521_addcarryx_u32(&x356, &x357, x355, x260, x331);
  fiat_np521_addcarryx_u32(&x358, &x359, x357, x261, x332);
  fiat_np521_addcarryx_u32(&x360, &x361, x359, x262, x333);
  fiat_np521_addcarryx_u32(&x362, &x363, x361, x263, x334);
  fiat_np521_addcarryx_u32(&x364, &x365, x363, x264, x335);
  fiat_np521_addcarryx_u32(&x366, &x367, x365, x265, x336);
  fiat_np521_addcarryx_u32(&x368, &x369, x367, x266, x337);
  fiat_np521_addcarryx_u32(&x370, &x371, x369, x267, x338);
  fiat_np521_addcarryx_u32(&x372, &x373, x371, x268, x339);
  fiat_np521_subborrowx_u32(&x374, &x375, 0x0, x340, UINT32_C(0x91386409));
  fiat_np521_subborrowx_u32(&x376, &x377, x375, x342, UINT32_C(0xbb6fb71e));
  fiat_np521_subborrowx_u32(&x378, &x379, x377, x344, UINT32_C(0x899c47ae));
  fiat_np521_subborrowx_u32(&x380, &x381, x379, x346, UINT32_C(0x3bb5c9b8));
  fiat_np521_subborrowx_u32(&x382, &x383, x381, x348, UINT32_C(0xf709a5d0));
  fiat_np521_subborrowx_u32(&x384, &x385, x383, x350, UINT32_C(0x7fcc0148));
  fiat_np521_subborrowx_u32(&x386, &x387, x385, x352, UINT32_C(0xbf2f966b));
  fiat_np521_subborrowx_u32(&x388, &x389, x387, x354, UINT32_C(0x51868783));
  fiat_np521_subborrowx_u32(&x390, &x391, x389, x356, UINT32_C(0xfffffffa));
  fiat_np521_subborrowx_u32(&x392, &x393, x391, x358, UINT32_C(0xffffffff));
  fiat_np521_subborrowx_u32(&x394, &x395, x393, x360, UINT32_C(0xffffffff));
  fiat_np521_subborrowx_u32(&x396, &x397, x395, x362, UINT32_C(0xffffffff));
  fiat_np521_subborrowx_u32(&x398, &x399, x397, x364, UINT32_C(0xffffffff));
  fiat_np521_subborrowx_u32(&x400, &x401, x399, x366, UINT32_C(0xffffffff));
  fiat_np521_subborrowx_u32(&x402, &x403, x401, x368, UINT32_C(0xffffffff));
  fiat_np521_subborrowx_u32(&x404, &x405, x403, x370, UINT32_C(0xffffffff));
  fiat_np521_subborrowx_u32(&x406, &x407, x405, x372, UINT16_C(0x1ff));
  fiat_np521_subborrowx_u32(&x408, &x409, x407, x373, 0x0);
  fiat_np521_addcarryx_u32(&x410, &x411, 0x0, x6, 0x1);
  ...
  fiat_np521_cmovznz_u32(&x430, x165, x130, x96);
  fiat_np521_cmovznz_u32(&x431, x165, x132, x98);
  fiat_np521_cmovznz_u32(&x432, x165, x134, x100);
  fiat_np521_cmovznz_u32(&x433, x165, x136, x102);
  fiat_np521_cmovznz_u32(&x434, x165, x138, x104);
  fiat_np521_cmovznz_u32(&x435, x165, x140, x106);
  fiat_np521_cmovznz_u32(&x436, x165, x142, x108);
  fiat_np521_cmovznz_u32(&x437, x165, x144, x110);
  fiat_np521_cmovznz_u32(&x438, x165, x146, x112);
  fiat_np521_cmovznz_u32(&x439, x165, x148, x114);
  fiat_np521_cmovznz_u32(&x440, x165, x150, x116);
  fiat_np521_cmovznz_u32(&x441, x165, x152, x118);
  fiat_np521_cmovznz_u32(&x442, x165, x154, x120);
  fiat_np521_cmovznz_u32(&x443, x165, x156, x122);
  fiat_np521_cmovznz_u32(&x444, x165, x158, x124);
  fiat_np521_cmovznz_u32(&x445, x165, x160, x126);
  fiat_np521_cmovznz_u32(&x446, x165, x162, x128);
  fiat_np521_cmovznz_u32(&x447, x409, x374, x340);
  fiat_np521_cmovznz_u32(&x448, x409, x376, x342);
  fiat_np521_cmovznz_u32(&x449, x409, x378, x344);
  fiat_np521_cmovznz_u32(&x450, x409, x380, x346);
  fiat_np521_cmovznz_u32(&x451, x409, x382, x348);
  fiat_np521_cmovznz_u32(&x452, x409, x384, x350);
  fiat_np521_cmovznz_u32(&x453, x409, x386, x352);
  fiat_np521_cmovznz_u32(&x454, x409, x388, x354);
  fiat_np521_cmovznz_u32(&x455, x409, x390, x356);
  fiat_np521_cmovznz_u32(&x456, x409, x392, x358);
  fiat_np521_cmovznz_u32(&x457, x409, x394, x360);
  fiat_np521_cmovznz_u32(&x458, x409, x396, x362);
  fiat_np521_cmovznz_u32(&x459, x409, x398, x364);
  fiat_np521_cmovznz_u32(&x460, x409, x400, x366);
  fiat_np521_cmovznz_u32(&x461, x409, x402, x368);
  fiat_np521_cmovznz_u32(&x462, x409, x404, x370);
  fiat_np521_cmovznz_u32(&x463, x409, x406, x372);
  *out1 = x410;
  out2[0] = x7;
  out2[1] = x8;
  out2[2] = x9;
 ...
 */
static FIAT_NP521_FIAT_INLINE void fiat_np521_to_bytes(uint8_t out1[66], const uint32_t arg1[17]) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
 ...
 */
static FIAT_NP521_FIAT_INLINE void fiat_np521_from_bytes(uint32_t out1[17], const uint8_t arg1[66]) {
  uint32_t x1;
  uint8_t x2;
  uint32_t x3;
  uint32_t x4;
 ...
 *   out1: [[0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff], [0x0 ~> 0xffffffff]]
 */
static FIAT_NP521_FIAT_INLINE void fiat_np521_selectznz(uint32_t out1[17], fiat_np521_uint1 arg1, const uint32_t arg2[17], const uint32_t arg3[17]) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
