...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7bd30f11abd4933d1a3922dd5cba55aa) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/mirage/mirage-entropy";
          synopsis = "Entropy provider for MirageOS on Xen";
          description =
            Some [OASISText.Para "Entropy provider for MirageOS on Xen."];
          categories = [];
          ...
          conf_custom =
            {
               ...
               post_command =
                 [(OASISExpr.EBool true, Some (("./postconf", [])))]
            };
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = ["entropy_cpu_xen_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt =
                        [
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "Sf\200\186N__\157b\247\230q\012Zc<";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
