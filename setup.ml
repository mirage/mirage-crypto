...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8421e76481629ec0e023c2f977bef907) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "mirage-entropy";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "mirage_entropy_unix";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("mirage-types", None);
                           InternalLibrary "mirage_entropy"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mirage-entropy-unix";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "mirage_entropy_xen";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mirage-entropy-xen";
                      lib_findlib_containers = []
                   })
            ];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "lp\206\159\169\199\164^U5\179\147\029\189\129\007";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
