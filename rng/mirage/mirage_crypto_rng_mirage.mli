(** {b RNG} seeding on {b Mirage}.
    ...
    {!Mirage_crypto_rng_unix} should be used in preference.
    ...
    and seeding of the Mirage-crypto RNG. There is no need to use this module
    directly.
*)
...
val attach : Entropy.t -> Mirage_crypto_rng.g -> Entropy.token Lwt.t
